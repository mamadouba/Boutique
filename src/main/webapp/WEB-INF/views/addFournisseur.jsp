...
        <h2>Enregistrement d'un fournisseur</h2>
		...
		<spring:url value="/fournisseur/add" var="addUrl"></spring:url>
        <form:form class="form-horizontal" modelAttribute="fournisseur" method="post" action="${addUrl}" >
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<form:input path="telephone" type="tel" class="form-control" id="telephone" value="${fournisseur.nom}" placeholder="Téléphone" pattern="^[0-9]{10}$" required="required"/>
